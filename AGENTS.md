...
- Bump `APP_VERSION` (near `FIRST_WORD_GRACE`) on every user-facing change — it's shown at the bottom of the settings sheet and in the tab title, and is how the user verifies the deployed version on GitHub Pages.
